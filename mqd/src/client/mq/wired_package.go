...
func ValueOf(rawData *IoBuffer, connKey int64) *WiredPackage {
	if rawData == nil {
...
func putStartAndId(connKey int64, responsePackage *IoBuffer) {
...
func putStart(responsePackage *IoBuffer) {
	responsePackage.WriteByte(LC_PACKAGE_START_IDENTIFY_BYTE_1)
	responsePackage.WriteByte(LC_PACKAGE_START_IDENTIFY_BYTE_2)
}

func putLengthAndPayload(payload []byte, responsePackage *IoBuffer) uint16 {
...
func putChecksumAndFlip(responsePackage *IoBuffer, checksum int64) {
...
func Initialize2LongConnRegisterResponsePackage(responseCode byte, connKey int64, sendHeartbeatInterval int32, noHeartbeatResponseTimeForDeathConn int32, reconnectInterval int32,
	isRedirect bool, isUsingContinuousHeartbeat bool, isCompressPushBody bool, serverAddr string, serversAddr []string, responsePackage *IoBuffer) error {
	if serversAddr == nil {
...
func Initialize2LongConnHeartbeatRequestPackage(requestPackage *IoBuffer) {
...
func Initialize2LongConnRegisterRequestPackage(appKey string, appSecret string, deviceId string, extDevInfo string, requestPackage *IoBuffer) error {
...
func Initialize2LongConnHeartbeatResponsePackage(responsePackage *IoBuffer) {
	putStart(responsePackage)
...
func Initialize2ServerLineTestRequestPackage(requestPackage *IoBuffer) {
	putStart(requestPackage)
...
func Initialize2ServerLineTestResponsePackage(responsePackage *IoBuffer) {
	putStart(responsePackage)
...
func getIntFromPayload(payload []byte, offset int) int32 {
	...
	return Combine4Bytes2Int32(uint32(byte1), uint32(byte2), uint32(byte3), uint32(byte4))
}
...
func GetLongConnActionInfoFromPayload(payload []byte, isCompressBody bool) (actionName string, messageId int64, longConnBody []byte, ex error) {
	if isCompressBody {
		unzipPayload, err := UnGZip(payload)
		if err != nil {
			return "", -1, nil, err
		}
	...
	payloadBuffer := NewIoBuffer(payload)
...
func GetLongConnRegisterDeviceAliasInfoFromActionBody(actionBody []byte) (int64, string) {
	payloadBuffer := NewIoBuffer(actionBody)
...
func Initialize2ServerLongConnCallRequestPackage(longConnActionName string, msgId int64, longConnActionBody []byte, isCompressBody bool, requestPackage *IoBuffer) error {
...
func Initialize2ServerLongConnCallResponsePackage(longConnActionName string, msgId int64, longConnActionBody []byte, isCompressBody bool, requestPackage *IoBuffer) error {
	checkLongConnActionBody(longConnActionBody)
	putStart(requestPackage)
...
func Initialize2ClientLongConnCallRequestPackage(longConnActionName string, msgId int64, longConnActionBody []byte, isCompressBody bool, requestPackage *IoBuffer) error {
	checkLongConnActionBody(longConnActionBody)
	putStart(requestPackage)
...
func Initialize2ClientLongConnCallResponsePackage(longConnActionName string, msgId int64, longConnActionBody []byte, isCompressBody bool, requestPackage *IoBuffer) error {
	checkLongConnActionBody(longConnActionBody)
	putStart(requestPackage)
...
func Initialize2ServerReliablePushRequestPackage(actionName string, msgId int64, actionBody []byte, isCompressBody bool, requestPackage *IoBuffer) error {
...
func Initialize2ClientReliablePushResponsePackage(actionName string, msgId int64, actionBody []byte, isCompressBody bool, requestPackage *IoBuffer) error {
	checkLongConnActionBody(actionBody)
	putStart(requestPackage)
